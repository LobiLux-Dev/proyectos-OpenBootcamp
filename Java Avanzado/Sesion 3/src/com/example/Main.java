...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(sumaFuncionalVariable.apply(5));
    }

    public static Function<Integer,Integer> sumaFuncionalVariable = x -> IntStream.rangeClosed(1, x).reduce(0, (a, b) -> a + b);
